...
RESULT_DIR = "/home/bcml1/sigenv/_6주차_label_mix/label_test1"
...
# Flag to apply label random mix on test labels
apply_random_label = True
...
for subj in unique_subjects:
    ...
    # --- Test Label Random Mix 적용 ---
    if apply_random_label:
        np.random.seed(42)
        Y_test = np.random.permutation(Y_test)
        print("Test labels have been randomly mixed.")
