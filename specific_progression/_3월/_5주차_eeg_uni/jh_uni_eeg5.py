...
# Raw branch: DepthwiseConv2D를 사용하여 채널별 특징 학습 후, Global Average Pooling으로 단일 벡터 생성
...
# 개선된 멀티모달 모델 구성: 각 branch에서 하나의 토큰을 추출하여 2개의 segment로 Transformer에 입력
def build_multimodal_model(de_input_shape=(4,8,8,1), raw_input_shape=(62,200,4),
    ...
    # 두 branch의 토큰 시퀀스 결합: 결과 (batch, 2, d_model)
