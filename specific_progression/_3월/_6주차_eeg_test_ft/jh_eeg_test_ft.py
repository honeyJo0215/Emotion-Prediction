...
RESULT_DIR = "/home/bcml1/sigenv/_6주차_eeg_test_ft/eeg_test_ft_1"
...
def build_single_segment_model(d_model=64):
    ...
    combined_features = Dense(d_model, activation="relu", kernel_regularizer=l2(1e-4))(combined_features)  # (d_model,)
...
def build_model(input_shape=(10, 2, 4, 8, 8, 1), n_layers=2, n_heads=4, d_ff=512, p_drop=0.3, d_model=64):
    """
...
for subj in unique_subjects:
    ...
    model.fit(ft_dataset, epochs=10)
