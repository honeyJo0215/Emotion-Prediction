...
SAVE_PATH = "/home/bcml1/myenv/DEAP2_3D1s_Results"
...
def train_subjects_with_kfold():
    ...
    for subject in subjects:
        ...
        test_report = classification_report(test_labels, predicted_labels, target_names=["Negative", "Positive", "Neutral"], labels=[0, 1, 2], zero_division=0)
        print(f"\nTest Report for {subject}")
        print(test_report)
