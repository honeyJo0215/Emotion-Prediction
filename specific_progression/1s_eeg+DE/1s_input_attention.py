...
SAVE_PATH = "/home/bcml1/sigenv/1s_eeg+DE/1s_test"
...
class SpatialSpectralConvModule(tf.keras.layers.Layer):
    def __init__(self, filters, kernel_size, strides):
        ...
        self.spectral_conv = Conv3D(filters, kernel_size=(3, 1, 1), strides=strides, padding="same", activation="relu")
...
class TransformerEncoder(tf.keras.Model):
    def __init__(self, input_dim, n_layers=6, n_heads=8, d_ff=2048, p_drop=0.5, d_model=64):
        ...
        # Conv3D 필터 수 감소
        self.conv_block1 = SpatialSpectralConvModule(8, kernel_size=(3, 3, 3), strides=(1, 2, 2))   # 16 -> 8
        self.conv_block2 = SpatialSpectralConvModule(16, kernel_size=(3, 3, 3), strides=(1, 2, 2))  # 32 -> 16
        self.conv_block3 = SpatialSpectralConvModule(32, kernel_size=(3, 3, 3), strides=(1, 2, 2))  # 64 -> 32
