...
SAVE_PATH = "/home/bcml1/myenv/DEAP_Multimodal"
...
#             f.write(test_report)
def train_multimodal():
    subjects = [f"s{str(i).zfill(2)}" for i in range(6, 7)]
    for subject in subjects:
        print(f"Training subject: {subject}")
        ...
        unique_samples = np.arange(len(eeg_data))  # 🟢 샘플 인덱스 생성
