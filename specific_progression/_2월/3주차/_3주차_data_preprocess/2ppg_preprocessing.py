...
ppg_npy_folder = "/home/bcml1/2025_EMOTION/DEAP_PPG/"   #s01_ppg_signals_segment_00.npy (1초 길이 데이터)
output_folder = "/home/bcml1/2025_EMOTION/DEAP_PPG_1s/"
...
# === 1. 파일 목록 가져오기 ===
eeg_files = sorted([f for f in os.listdir(ppg_npy_folder) if f.endswith(".npy")])
print(f"📂 총 {len(eeg_files)}개의 PPG 파일을 찾았습니다.")

# === 2. 파일별 전처리 ===
for eeg_file in eeg_files:
    file_path = os.path.join(ppg_npy_folder, eeg_file)
    
    # === 2.1 데이터 로드 ===
    eeg_data = np.load(file_path)  # Shape: (40, 8064)
