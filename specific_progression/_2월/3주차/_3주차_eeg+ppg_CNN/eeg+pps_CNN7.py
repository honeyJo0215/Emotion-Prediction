...
SAVE_PATH    = "/home/bcml1/sigenv/_3주차_eeg+pps_CNN/result6"
...
# =============================================================================
# 데이터 증강 함수 수정: EEG와 PPG에 대해 각기 다른 노이즈 스케일 적용
# =============================================================================
...
def train_multimodal():
    ...
    for subject in subjects:
        ...
        # 먼저 원본 train 데이터를 클래스별로 균형 맞춤 (오버샘플링 with replacement)
        ...
        # EarlyStopping: val_accuracy 개선폭(min_delta)이 0.001 이상 없으면 10 에포크 후 종료
        callbacks = [
