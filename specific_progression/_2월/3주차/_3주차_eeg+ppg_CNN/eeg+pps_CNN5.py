...
SAVE_PATH    = "/home/bcml1/sigenv/_3주차_eeg+pps_CNN/result5"
...
class MultimodalEmotionClassifier(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            losses = tf.stack([loss_inter, loss_eeg, loss_ppg], axis=1)
...
def train_multimodal():
    ...
    for subject in subjects:
        ...
        # EarlyStopping (patience=10, monitor val_accuracy) 및 ReduceLROnPlateau callback 적용
        callbacks = [
            tf.keras.callbacks.EarlyStopping(monitor='val_accuracy', patience=50, restore_best_weights=True, verbose=1),
