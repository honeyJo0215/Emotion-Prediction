...
# SAMPLE_SECONDS: 몇 초 단위로 입력을 구성할지 결정 (1초=128 sample)
SAMPLE_SECONDS = 4
...
def create_dual_stream_feature_extractor(eeg_input_shape=(32,128,1), pps_input_shape=(8,128,1)):
    ...
    - EEG Branch: 입력 shape 지정 (예: (32, 128, 1))  
    - PPS Branch: 입력 shape 지정 (예: (8, 128, 1))
    """
    ## EEG Branch
...
# =============================================================================
# 8. 데이터 로드 함수  
# 각 피험자별 파일들을 모두 이어붙여, (num_files*new_samples, 32, 128*sample_seconds, 1) 형태의 데이터를 생성
# =============================================================================
def load_multimodal_data(subject, sample_seconds=1):
    ...
    # EEG 파일 로드 및 라벨 추출 + segment 이어붙이기
