...
output_dir = "/home/bcml1/2025_EMOTION/DEAP_PPG_1s_nonorm/"
...
for subject_id in range(1, 23):
    ...
    ppg_identity = ppg_data.copy()

    # 7️⃣ Multi-Frequency 변환 (다양한 스케일에서 smoothing)
    ppg_smooth_s2, ppg_smooth_s3 = multi_frequency_smoothing(ppg_data)
...
print("🎯 모든 데이터 변환 완료! 변환된 파일이 DEAP_PPG_1s_nonorm 폴더에 저장되었습니다.")
