...
def train_model_for_subject(subject_id, X, y, num_classes=4, epochs=300, batch_size=128):
    ...
    result_dir = os.path.join(RESULT_DIR, subject_id)
...
if __name__ == "__main__":
    ...
    if mode == '1s':
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/diff_EMCNN_intra_1s'
    elif mode == '10s':
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/diff_EMCNN_intra_10s'
    else:
    ...
    for subject_id in sorted(subject_data.keys(), key=lambda x: int(x[1:])):
        ...
        train_model_for_subject(subject_id, X, y, num_classes=4, epochs=300, batch_size=128)