...
def train_model_for_subject_with_random_labels(subject_id, X, y, num_classes=4, epochs=50, batch_size=8,
    ...
    각 fold의 classification report는 아래와 같은 형식으로 저장되고,
    ...
    for train_index, test_index in kfold.split(X):
        ...
        # 훈련 시에는 원본 라벨 사용, 테스트 시에는 무작위 재배분 적용
        ...
        # 저장되는 report는 sklearn의 classification_report 함수가 출력하는 형식으로
    ...
    # Global classification report: concatenate 모든 fold의 y_true, y_pred
...
# -----------------------------
# ch_choice_pair1: 두번째와 세번째 채널 중 선택 (기본값 1)
# ch_choice_pair2: 네번째와 다섯번째 채널 중 선택 (기본값 3)
def load_data_1s(data_dir, ch_choice_pair1=1, ch_choice_pair2=3):
    """
    DEAP_PPG_1s 폴더 파일 로드
    파일 shape: (60, 5, 128)
    -> 원하는 3채널: [0, ch_choice_pair1, ch_choice_pair2] 선택 후 (60, 128, 3)로 변환
    """
    subject_data = {}
    ...
    for file_path in file_paths:
        ...
        # 선택: 첫 채널은 항상 사용, 두번째/세번째 중 ch_choice_pair1, 네번째/다섯번째 중 ch_choice_pair2 선택
...
def load_data_10s(data_dir, ch_choice_pair1=1, ch_choice_pair2=3):
    ...
    파일 shape: (51, 5, 1280)
    1. os.listdir를 사용하여 파일 목록 생성 (논문 그대로 구현한 코드 방식)
    2. 각 파일을 np.load로 읽은 후, transpose하여 (51, 1280, 5)로 변경
    3. 원하는 3채널: [0, ch_choice_pair1, ch_choice_pair2] 선택 -> (51, 1280, 3)
    -> 51개의 모든 segment를 사용 (최종 shape: (51, 1280, 3))
    """
    subject_data = {}
...
if __name__ == "__main__":
    ...
    if mode == '1s':
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/EMCNN_LabelMix_Results_1s_3ch'
    elif mode == '10s':
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/EMCNN_LabelMix_Results_10s_3ch'
    else:
