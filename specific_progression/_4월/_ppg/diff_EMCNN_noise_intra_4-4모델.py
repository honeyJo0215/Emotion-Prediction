...
# 가우시안 노이즈 추가 함수
# =============================================================================
def add_diffusion_noise_numpy(x, stddev=0.02):
...
if __name__ == "__main__":
    ...
    if mode == '1s':
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/diff_EMCNN_noise_1s_intra'
    elif mode == '10s':
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/diff_EMCNN_noise_intra_10s_intra'
        ...
        result_dir_base = '/home/bcml1/sigenv/_4월/_ppg/diff_EMCNN_noise_10s_1soverlap_intra'
    else:
        raise ValueError("mode는 '1s' 또는 '10s'여야 합니다.")

    # 각 피실험자별로 intra-subject cross validation 수행
    start_subject = 's20'  # <- 시작할 subject 설정
    all_subjects = sorted(subject_data.keys(), key=lambda x: int(x[1:]))
