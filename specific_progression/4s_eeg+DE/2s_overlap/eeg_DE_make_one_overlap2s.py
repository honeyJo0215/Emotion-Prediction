...
def process_and_save_combined_data(test_dir, train_dir, de_dir, output_test_dir, output_train_dir):
    ...
    def convert_eeg_to_de_name(eeg_filename):
        ...
        """
        return eeg_filename.replace("_segment_", "_FB_segment_").replace("_2D.npy", "_de_features.npy")
...
process_and_save_combined_data(
    test_dir="/home/bcml1/2025_EMOTION/DEAP_EEG/overlap4s_seg_conv_ch_BPF/2D_real/test",
    train_dir="/home/bcml1/2025_EMOTION/DEAP_EEG/overlap4s_seg_conv_ch_BPF/2D_real",
    de_dir="/home/bcml1/sigenv/4s_DE_feature/de_features",
    output_test_dir="/home/bcml1/2025_EMOTION/DEAP_EEG/overlap4s_seg_conv_ch_BPF+DE/test",
    output_train_dir="/home/bcml1/2025_EMOTION/DEAP_EEG/overlap4s_seg_conv_ch_BPF+DE/train"
)
